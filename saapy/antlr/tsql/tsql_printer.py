...
from antlr4 import *
from .autogen import tsqlLexer, tsqlParser, tsqlListener
...
class TsqlPrinter(tsqlListener):
    ...
    def enterContinue_statement(self,
                                ctx: tsqlParser.Continue_statementContext):
        pass
    ...
    def enterTry_catch_statement(self,
                                 ctx: tsqlParser.Try_catch_statementContext):
        pass

    # Exit a parse tree produced by tsqlParser#try_catch_statement.
    def exitTry_catch_statement(self,
                                ctx: tsqlParser.Try_catch_statementContext):
        pass
    ...
    def enterRaiseerror_statement(self,
                                  ctx: tsqlParser.Raiseerror_statementContext):
        pass

    # Exit a parse tree produced by tsqlParser#raiseerror_statement.
    def exitRaiseerror_statement(self,
                                 ctx: tsqlParser.Raiseerror_statementContext):
        pass
    ...
    def enterDelete_statement_from(self,
                                   ctx: tsqlParser.Delete_statement_fromContext):
        pass

    # Exit a parse tree produced by tsqlParser#delete_statement_from.
    def exitDelete_statement_from(self,
                                  ctx: tsqlParser.Delete_statement_fromContext):
        pass
    ...
    def enterInsert_statement_value(self,
                                    ctx: tsqlParser.Insert_statement_valueContext):
        pass

    # Exit a parse tree produced by tsqlParser#insert_statement_value.
    def exitInsert_statement_value(self,
                                   ctx: tsqlParser.Insert_statement_valueContext):
        pass
    ...
    def enterOutput_dml_list_elem(self,
                                  ctx: tsqlParser.Output_dml_list_elemContext):
        pass

    # Exit a parse tree produced by tsqlParser#output_dml_list_elem.
    def exitOutput_dml_list_elem(self,
                                 ctx: tsqlParser.Output_dml_list_elemContext):
        pass

    # Enter a parse tree produced by tsqlParser#output_column_name.
    def enterOutput_column_name(self,
                                ctx: tsqlParser.Output_column_nameContext):
        pass
    ...
    def enterDatabase_optionspec(self,
                                 ctx: tsqlParser.Database_optionspecContext):
        pass

    # Exit a parse tree produced by tsqlParser#database_optionspec.
    def exitDatabase_optionspec(self,
                                ctx: tsqlParser.Database_optionspecContext):
        pass
    ...
    def enterChange_tracking_option(self,
                                    ctx: tsqlParser.Change_tracking_optionContext):
        pass

    # Exit a parse tree produced by tsqlParser#change_tracking_option.
    def exitChange_tracking_option(self,
                                   ctx: tsqlParser.Change_tracking_optionContext):
        pass

    # Enter a parse tree produced by tsqlParser#change_tracking_option_list.
    def enterChange_tracking_option_list(self,
                                         ctx: tsqlParser.Change_tracking_option_listContext):
        pass

    # Exit a parse tree produced by tsqlParser#change_tracking_option_list.
    def exitChange_tracking_option_list(self,
                                        ctx: tsqlParser.Change_tracking_option_listContext):
        pass

    # Enter a parse tree produced by tsqlParser#containment_option.
    def enterContainment_option(self,
                                ctx: tsqlParser.Containment_optionContext):
        pass
    ...
    def enterDate_correlation_optimization_option(self,
                                                  ctx: tsqlParser.Date_correlation_optimization_optionContext):
        pass

    # Exit a parse tree produced by tsqlParser#date_correlation_optimization_option.
    def exitDate_correlation_optimization_option(self,
                                                 ctx: tsqlParser.Date_correlation_optimization_optionContext):
        pass

    # Enter a parse tree produced by tsqlParser#db_encryption_option.
    def enterDb_encryption_option(self,
                                  ctx: tsqlParser.Db_encryption_optionContext):
        pass

    # Exit a parse tree produced by tsqlParser#db_encryption_option.
    def exitDb_encryption_option(self,
                                 ctx: tsqlParser.Db_encryption_optionContext):
        pass
    ...
    def enterDb_user_access_option(self,
                                   ctx: tsqlParser.Db_user_access_optionContext):
        pass

    # Exit a parse tree produced by tsqlParser#db_user_access_option.
    def exitDb_user_access_option(self,
                                  ctx: tsqlParser.Db_user_access_optionContext):
        pass

    # Enter a parse tree produced by tsqlParser#delayed_durability_option.
    def enterDelayed_durability_option(self,
                                       ctx: tsqlParser.Delayed_durability_optionContext):
        pass

    # Exit a parse tree produced by tsqlParser#delayed_durability_option.
    def exitDelayed_durability_option(self,
                                      ctx: tsqlParser.Delayed_durability_optionContext):
        pass

    # Enter a parse tree produced by tsqlParser#external_access_option.
    def enterExternal_access_option(self,
                                    ctx: tsqlParser.External_access_optionContext):
        pass

    # Exit a parse tree produced by tsqlParser#external_access_option.
    def exitExternal_access_option(self,
                                   ctx: tsqlParser.External_access_optionContext):
        pass

    # Enter a parse tree produced by tsqlParser#mixed_page_allocation_option.
    def enterMixed_page_allocation_option(self,
                                          ctx: tsqlParser.Mixed_page_allocation_optionContext):
        pass

    # Exit a parse tree produced by tsqlParser#mixed_page_allocation_option.
    def exitMixed_page_allocation_option(self,
                                         ctx: tsqlParser.Mixed_page_allocation_optionContext):
        pass

    # Enter a parse tree produced by tsqlParser#parameterization_option.
    def enterParameterization_option(self,
                                     ctx: tsqlParser.Parameterization_optionContext):
        pass

    # Exit a parse tree produced by tsqlParser#parameterization_option.
    def exitParameterization_option(self,
                                    ctx: tsqlParser.Parameterization_optionContext):
        pass
    ...
    def enterService_broker_option(self,
                                   ctx: tsqlParser.Service_broker_optionContext):
        pass

    # Exit a parse tree produced by tsqlParser#service_broker_option.
    def exitService_broker_option(self,
                                  ctx: tsqlParser.Service_broker_optionContext):
        pass
    ...
    def enterTarget_recovery_time_option(self,
                                         ctx: tsqlParser.Target_recovery_time_optionContext):
        pass

    # Exit a parse tree produced by tsqlParser#target_recovery_time_option.
    def exitTarget_recovery_time_option(self,
                                        ctx: tsqlParser.Target_recovery_time_optionContext):
        pass
    ...
    def enterRowset_function_limited(self,
                                     ctx: tsqlParser.Rowset_function_limitedContext):
        pass

    # Exit a parse tree produced by tsqlParser#rowset_function_limited.
    def exitRowset_function_limited(self,
                                    ctx: tsqlParser.Rowset_function_limitedContext):
        pass
    ...
    def enterExecute_statement_arg(self,
                                   ctx: tsqlParser.Execute_statement_argContext):
        pass

    # Exit a parse tree produced by tsqlParser#execute_statement_arg.
    def exitExecute_statement_arg(self,
                                  ctx: tsqlParser.Execute_statement_argContext):
        pass

    # Enter a parse tree produced by tsqlParser#execute_var_string.
    def enterExecute_var_string(self,
                                ctx: tsqlParser.Execute_var_stringContext):
        pass
    ...
    def enterSecurity_statement(self,
                                ctx: tsqlParser.Security_statementContext):
        pass
    ...
    def enterTransaction_statement(self,
                                   ctx: tsqlParser.Transaction_statementContext):
        pass

    # Exit a parse tree produced by tsqlParser#transaction_statement.
    def exitTransaction_statement(self,
                                  ctx: tsqlParser.Transaction_statementContext):
        pass
    ...
    def enterTable_type_definition(self,
                                   ctx: tsqlParser.Table_type_definitionContext):
        pass

    # Exit a parse tree produced by tsqlParser#table_type_definition.
    def exitTable_type_definition(self,
                                  ctx: tsqlParser.Table_type_definitionContext):
        pass

    # Enter a parse tree produced by tsqlParser#column_def_table_constraints.
    def enterColumn_def_table_constraints(self,
                                          ctx: tsqlParser.Column_def_table_constraintsContext):
        pass

    # Exit a parse tree produced by tsqlParser#column_def_table_constraints.
    def exitColumn_def_table_constraints(self,
                                         ctx: tsqlParser.Column_def_table_constraintsContext):
        pass

    # Enter a parse tree produced by tsqlParser#column_def_table_constraint.
    def enterColumn_def_table_constraint(self,
                                         ctx: tsqlParser.Column_def_table_constraintContext):
        pass

    # Exit a parse tree produced by tsqlParser#column_def_table_constraint.
    def exitColumn_def_table_constraint(self,
                                        ctx: tsqlParser.Column_def_table_constraintContext):
        pass
    ...
    def enterDeclare_set_cursor_common(self,
                                       ctx: tsqlParser.Declare_set_cursor_commonContext):
        pass

    # Exit a parse tree produced by tsqlParser#declare_set_cursor_common.
    def exitDeclare_set_cursor_common(self,
                                      ctx: tsqlParser.Declare_set_cursor_commonContext):
        pass
    ...
    def enterBinary_operator_expression(self,
                                        ctx: tsqlParser.Binary_operator_expressionContext):
        pass

    # Exit a parse tree produced by tsqlParser#binary_operator_expression.
    def exitBinary_operator_expression(self,
                                       ctx: tsqlParser.Binary_operator_expressionContext):
        pass

    # Enter a parse tree produced by tsqlParser#primitive_expression.
    def enterPrimitive_expression(self,
                                  ctx: tsqlParser.Primitive_expressionContext):
        pass

    # Exit a parse tree produced by tsqlParser#primitive_expression.
    def exitPrimitive_expression(self,
                                 ctx: tsqlParser.Primitive_expressionContext):
        pass

    # Enter a parse tree produced by tsqlParser#unary_operator_expression.
    def enterUnary_operator_expression(self,
                                       ctx: tsqlParser.Unary_operator_expressionContext):
        pass

    # Exit a parse tree produced by tsqlParser#unary_operator_expression.
    def exitUnary_operator_expression(self,
                                      ctx: tsqlParser.Unary_operator_expressionContext):
        pass

    # Enter a parse tree produced by tsqlParser#bracket_expression.
    def enterBracket_expression(self,
                                ctx: tsqlParser.Bracket_expressionContext):
        pass
    ...
    def enterFunction_call_expression(self,
                                      ctx: tsqlParser.Function_call_expressionContext):
        pass

    # Exit a parse tree produced by tsqlParser#function_call_expression.
    def exitFunction_call_expression(self,
                                     ctx: tsqlParser.Function_call_expressionContext):
        pass
    ...
    def enterColumn_ref_expression(self,
                                   ctx: tsqlParser.Column_ref_expressionContext):
        pass

    # Exit a parse tree produced by tsqlParser#column_ref_expression.
    def exitColumn_ref_expression(self,
                                  ctx: tsqlParser.Column_ref_expressionContext):
        pass

    # Enter a parse tree produced by tsqlParser#subquery_expression.
    def enterSubquery_expression(self,
                                 ctx: tsqlParser.Subquery_expressionContext):
        pass

    # Exit a parse tree produced by tsqlParser#subquery_expression.
    def exitSubquery_expression(self,
                                ctx: tsqlParser.Subquery_expressionContext):
        pass

    # Enter a parse tree produced by tsqlParser#over_clause_expression.
    def enterOver_clause_expression(self,
                                    ctx: tsqlParser.Over_clause_expressionContext):
        pass

    # Exit a parse tree produced by tsqlParser#over_clause_expression.
    def exitOver_clause_expression(self,
                                   ctx: tsqlParser.Over_clause_expressionContext):
        pass

    # Enter a parse tree produced by tsqlParser#constant_expression.
    def enterConstant_expression(self,
                                 ctx: tsqlParser.Constant_expressionContext):
        pass

    # Exit a parse tree produced by tsqlParser#constant_expression.
    def exitConstant_expression(self,
                                ctx: tsqlParser.Constant_expressionContext):
        pass
    ...
    def enterCommon_table_expression(self,
                                     ctx: tsqlParser.Common_table_expressionContext):
        pass

    # Exit a parse tree produced by tsqlParser#common_table_expression.
    def exitCommon_table_expression(self,
                                    ctx: tsqlParser.Common_table_expressionContext):
        pass
    ...
    def enterSearch_condition_list(self,
                                   ctx: tsqlParser.Search_condition_listContext):
        pass

    # Exit a parse tree produced by tsqlParser#search_condition_list.
    def exitSearch_condition_list(self,
                                  ctx: tsqlParser.Search_condition_listContext):
        pass
    ...
    def enterSearch_condition_and(self,
                                  ctx: tsqlParser.Search_condition_andContext):
        pass

    # Exit a parse tree produced by tsqlParser#search_condition_and.
    def exitSearch_condition_and(self,
                                 ctx: tsqlParser.Search_condition_andContext):
        pass

    # Enter a parse tree produced by tsqlParser#search_condition_not.
    def enterSearch_condition_not(self,
                                  ctx: tsqlParser.Search_condition_notContext):
        pass

    # Exit a parse tree produced by tsqlParser#search_condition_not.
    def exitSearch_condition_not(self,
                                 ctx: tsqlParser.Search_condition_notContext):
        pass
    ...
    def enterQuery_specification(self,
                                 ctx: tsqlParser.Query_specificationContext):
        pass
    ...
    def enterXml_common_directives(self,
                                   ctx: tsqlParser.Xml_common_directivesContext):
        pass

    # Exit a parse tree produced by tsqlParser#xml_common_directives.
    def exitXml_common_directives(self,
                                  ctx: tsqlParser.Xml_common_directivesContext):
        pass

    # Enter a parse tree produced by tsqlParser#order_by_expression.
    def enterOrder_by_expression(self,
                                 ctx: tsqlParser.Order_by_expressionContext):
        pass

    # Exit a parse tree produced by tsqlParser#order_by_expression.
    def exitOrder_by_expression(self,
                                ctx: tsqlParser.Order_by_expressionContext):
        pass
    ...
    def enterTable_source_item_joined(self,
                                      ctx: tsqlParser.Table_source_item_joinedContext):
        pass

    # Exit a parse tree produced by tsqlParser#table_source_item_joined.
    def exitTable_source_item_joined(self,
                                     ctx: tsqlParser.Table_source_item_joinedContext):
        pass
    ...
    def enterTable_name_with_hint(self,
                                  ctx: tsqlParser.Table_name_with_hintContext):
        pass

    # Exit a parse tree produced by tsqlParser#table_name_with_hint.
    def exitTable_name_with_hint(self,
                                 ctx: tsqlParser.Table_name_with_hintContext):
        pass
    ...
    def enterSwitch_search_condition_section(self,
                                             ctx: tsqlParser.Switch_search_condition_sectionContext):
        pass

    # Exit a parse tree produced by tsqlParser#switch_search_condition_section.
    def exitSwitch_search_condition_section(self,
                                            ctx: tsqlParser.Switch_search_condition_sectionContext):
        pass
    ...
    def enterInsert_with_table_hints(self,
                                     ctx: tsqlParser.Insert_with_table_hintsContext):
        pass

    # Exit a parse tree produced by tsqlParser#insert_with_table_hints.
    def exitInsert_with_table_hints(self,
                                    ctx: tsqlParser.Insert_with_table_hintsContext):
        pass
    ...
    def enterTable_value_constructor(self,
                                     ctx: tsqlParser.Table_value_constructorContext):
        pass

    # Exit a parse tree produced by tsqlParser#table_value_constructor.
    def exitTable_value_constructor(self,
                                    ctx: tsqlParser.Table_value_constructorContext):
        pass
    ...
    def enterRanking_windowed_function(self,
                                       ctx: tsqlParser.Ranking_windowed_functionContext):
        pass

    # Exit a parse tree produced by tsqlParser#ranking_windowed_function.
    def exitRanking_windowed_function(self,
                                      ctx: tsqlParser.Ranking_windowed_functionContext):
        pass

    # Enter a parse tree produced by tsqlParser#aggregate_windowed_function.
    def enterAggregate_windowed_function(self,
                                         ctx: tsqlParser.Aggregate_windowed_functionContext):
        pass

    # Exit a parse tree produced by tsqlParser#aggregate_windowed_function.
    def exitAggregate_windowed_function(self,
                                        ctx: tsqlParser.Aggregate_windowed_functionContext):
        pass

    # Enter a parse tree produced by tsqlParser#all_distinct_expression.
    def enterAll_distinct_expression(self,
                                     ctx: tsqlParser.All_distinct_expressionContext):
        pass

    # Exit a parse tree produced by tsqlParser#all_distinct_expression.
    def exitAll_distinct_expression(self,
                                    ctx: tsqlParser.All_distinct_expressionContext):
        pass
    ...
    def enterRow_or_range_clause(self,
                                 ctx: tsqlParser.Row_or_range_clauseContext):
        pass

    # Exit a parse tree produced by tsqlParser#row_or_range_clause.
    def exitRow_or_range_clause(self,
                                ctx: tsqlParser.Row_or_range_clauseContext):
        pass

    # Enter a parse tree produced by tsqlParser#window_frame_extent.
    def enterWindow_frame_extent(self,
                                 ctx: tsqlParser.Window_frame_extentContext):
        pass

    # Exit a parse tree produced by tsqlParser#window_frame_extent.
    def exitWindow_frame_extent(self,
                                ctx: tsqlParser.Window_frame_extentContext):
        pass

    # Enter a parse tree produced by tsqlParser#window_frame_bound.
    def enterWindow_frame_bound(self,
                                ctx: tsqlParser.Window_frame_boundContext):
        pass
    ...
    def enterWindow_frame_preceding(self,
                                    ctx: tsqlParser.Window_frame_precedingContext):
        pass

    # Exit a parse tree produced by tsqlParser#window_frame_preceding.
    def exitWindow_frame_preceding(self,
                                   ctx: tsqlParser.Window_frame_precedingContext):
        pass

    # Enter a parse tree produced by tsqlParser#window_frame_following.
    def enterWindow_frame_following(self,
                                    ctx: tsqlParser.Window_frame_followingContext):
        pass

    # Exit a parse tree produced by tsqlParser#window_frame_following.
    def exitWindow_frame_following(self,
                                   ctx: tsqlParser.Window_frame_followingContext):
        pass

    # Enter a parse tree produced by tsqlParser#create_database_option.
    def enterCreate_database_option(self,
                                    ctx: tsqlParser.Create_database_optionContext):
        pass

    # Exit a parse tree produced by tsqlParser#create_database_option.
    def exitCreate_database_option(self,
                                   ctx: tsqlParser.Create_database_optionContext):
        pass

    # Enter a parse tree produced by tsqlParser#database_filestream_option.
    def enterDatabase_filestream_option(self,
                                        ctx: tsqlParser.Database_filestream_optionContext):
        pass

    # Exit a parse tree produced by tsqlParser#database_filestream_option.
    def exitDatabase_filestream_option(self,
                                       ctx: tsqlParser.Database_filestream_optionContext):
        pass

    # Enter a parse tree produced by tsqlParser#database_file_spec.
    def enterDatabase_file_spec(self,
                                ctx: tsqlParser.Database_file_specContext):
        pass
    ...
    def enterScalar_function_name(self,
                                  ctx: tsqlParser.Scalar_function_nameContext):
        pass

    # Exit a parse tree produced by tsqlParser#scalar_function_name.
    def exitScalar_function_name(self,
                                 ctx: tsqlParser.Scalar_function_nameContext):
        pass
    ...
    def enterComparison_operator(self,
                                 ctx: tsqlParser.Comparison_operatorContext):
        pass

    # Exit a parse tree produced by tsqlParser#comparison_operator.
    def exitComparison_operator(self,
                                ctx: tsqlParser.Comparison_operatorContext):
        pass

    # Enter a parse tree produced by tsqlParser#assignment_operator.
    def enterAssignment_operator(self,
                                 ctx: tsqlParser.Assignment_operatorContext):
        pass

    # Exit a parse tree produced by tsqlParser#assignment_operator.
    def exitAssignment_operator(self,
                                ctx: tsqlParser.Assignment_operatorContext):
        pass
